document.getElementById('addMusic').addEventListener('submit', event => { //getting the id 'addMusic' defined on the form of addMusic.html
    ...
    const image = document.getElementById('addMusicImage').value
    const genre = document.getElementById('addMusicGenre').value
    const featuring = document.getElementById('addMusicFeaturing').value
